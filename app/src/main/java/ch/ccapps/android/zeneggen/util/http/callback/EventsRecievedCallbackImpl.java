...
public class EventsRecievedCallbackImpl implements EventParticipationRestCall.EventParticipationRestCallback{

    private Activity activity;

    private static final String TAG = EditProfileActivity.class.getSimpleName();

    public EventsRecievedCallbackImpl(Activity activity){
